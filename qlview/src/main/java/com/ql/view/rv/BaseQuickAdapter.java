...
import com.ql.view.rv.animation.AlphaInAnimation;
import com.ql.view.rv.animation.BaseAnimation;
import com.ql.view.rv.animation.ScaleInAnimation;
import com.ql.view.rv.animation.SlideInBottomAnimation;
import com.ql.view.rv.animation.SlideInLeftAnimation;
import com.ql.view.rv.animation.SlideInRightAnimation;
import com.ql.view.rv.entity.IExpandable;
import com.ql.view.rv.loadmore.LoadMoreView;
import com.ql.view.rv.loadmore.SimpleLoadMoreView;
import com.ql.view.rv.util.MultiTypeDelegate;
import com.ql.view.utils.EmptyViewUtils;
 ...
 */
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IEmpty {
...
//            subItemCount += list.size();
    ...
    public void setEmptyViewUtils(EmptyViewUtils utils) {
        mEmptyViewUtils = utils;
    }

    public EmptyViewUtils getEmptyViewUtils() {
        if (mEmptyViewUtils == null) {
            mEmptyViewUtils = new EmptyViewUtils();

        }
        return mEmptyViewUtils;
    }

    @Override
    public void displayLoadingView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        empty.setType(EmptyViewUtils.TYPE_LOADING);
        setEmptyView(empty.getLoadingView());
    }

    @Override
    public void displayErrorView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        empty.setType(EmptyViewUtils.TYPE_ERROR);
        setEmptyView(empty.getErrorView());
    }

    @Override
    public void displayNoDataView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        empty.setType(EmptyViewUtils.TYPE_NO_DATA);
        setEmptyView(empty.getNoDataView());
    }
    ...
    public View getLoadingView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        return empty.getLoadingView();
    }

    @Override
    public View getErrorView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        return empty.getErrorView();
    }

    @Override
    public View getNoDateView() {
        EmptyViewUtils empty = getEmptyViewUtils();
        return empty.getNoDataView();
    }
}
